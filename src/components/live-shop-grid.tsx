...
import { products as fallbackProducts, type Product } from "@/lib/brand-data";
    ...
    <section className="border-y border-white/10 bg-black px-4 py-8 text-white sm:px-6 lg:px-8 lg:py-12">
      <div className="mx-auto max-w-[1600px]">
        ...
        <div className="mt-4 grid gap-3 border border-violet-300/35 bg-[#050507] p-4 font-mono text-xs uppercase tracking-[0.16em] text-zinc-200 sm:grid-cols-[1fr_auto] sm:items-center sm:p-5">
          <div>
            <p className="text-violet-200">Mirror state preserved</p>
            <p className="mt-2 text-zinc-400">
              AR-001 is live. AR-002 is locked but still visible.
            </p>
            <p className="mt-2 text-zinc-500">
              Checkout opens on Shopify only for mapped Galaxy tee variants.
            </p>
          </div>
          <p className="text-white">STATUS: UNLOCKED</p>
        </div>
      </div>
    </section>
  );
